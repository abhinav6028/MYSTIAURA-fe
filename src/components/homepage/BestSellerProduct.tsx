...
const bestSellerData = [
    ...
    {
        id: 4, image: bestSeller4, name: "Rose Gold Diamond Ring"
    },
    {
        id: 5, image: bestSeller5, name: "Rose Gold Lotus Necklace"
    },
    {
        id: 6, image: bestSeller6, name: "Diamond Engagement Ring"
    },
    {
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {bestSellerData?.map((val, index) => (
                    <div key={index} className="flex flex-col">
                        ...
                        <h3 className="mt-2 text-lg font-medium">{val.name}</h3>
                    </div>
                ))}
            </div>
