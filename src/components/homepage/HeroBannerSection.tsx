...
const HeroBannerSection = () => {
    return (
        <div style={{
            ...
            className="h-[50rem] text-white relative">
            <div className="absolute bottom-20 left-20">
                <h1 className="text-7xl max-w-[60%] mb-5">Unveiling the Beauty of Fine Jewelry</h1>
            ...
            <div className="absolute right-20 top-90">
