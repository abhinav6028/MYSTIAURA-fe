...
export default function PasswordSection({ setShowForm }) {
        ...
        <Dialog open={true}>
            <div className="fixed inset-0 flex md:items-center items-baseline-last justify-center bg-opacity-100 z-50">
                <div className="bg-white w-[100%] md:w-[500px] shadow-lg p-6 relative">
                    {/* Title */}
                    <h2 style={{ fontFamily: 'Prata' }} className="lg:text-3xl text-2xl font-medium text-gray-900 md:mb-1">Enter Password</h2>
                    <p className="text-gray-600 sm:text-lg md:mb-4 mb-2">Please enter your new password</p>
